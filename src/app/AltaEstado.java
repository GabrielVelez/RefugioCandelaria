...
public class AltaEstado extends javax.swing.JDialog {
    ...
    public AltaEstado(FrmMenuPrincipal ventanaPrincipal, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaEstado().setVisible(true);
            }
        });
    }
